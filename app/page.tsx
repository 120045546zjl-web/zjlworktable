...
export default function Home() {
  ...
  return <main className="workspace">
    <aside className="sidebar">
      ...
      <div className="side-bottom"><div className="profile"><i>Z</i><span><strong>ZJL</strong><small>个人空间</small></span><b>···</b></div></div>
    </aside>
    <section className="content" id="top">
      <header><div className="mobile-brand"><i>亮</i> 亮的工作台</div><div className="today">☼　星期三，7月30日</div></header>
      {active === "总览" ? <Overview tasks={tasks} done={done} toggle={toggle} addTask={addTask} /> : <SectionPage title={active} tasks={tasks} done={done} toggle={toggle} addTask={addTask} />}
    </section>
  </main>;
}
